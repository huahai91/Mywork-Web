        ...
        <div class="row">
            <ul class="pagination" style="margin-left: 60%;">
                <li class="paginate_button previous disabled" aria-controls="dataTables-example" tabindex="0"
                    id="dataTables-example_previous"><s:a action="newsAction_list?pageNum=1">首页</s:a></li>
                <s:iterator begin="%{beginPageIndex}" end="%{endPageIndex}" var="num">
                    <s:if test="%{currentPage} == #num">
                        <li class="paginate_button active" aria-controls="dataTables-example" tabindex="0">
                            <s:a action="newsAction_list?pageNum=%{num}">${num}</s:a>
                        </li>
                    </s:if>
                    <s:else>
                ...
                <li class="paginate_button next" aria-controls="dataTables-example" tabindex="0"
                    id="dataTables-example_next"><s:a action="newsAction_list?pageNum=%{endPageIndex}">尾页</s:a></li>
            </ul>
        </div>
        <!-- /.row -->
